...
#PATH_TO_YOUR_MCP_SERVER_SCRIPT = str((Path(__file__).parent.parent / "server.py").resolve())
PATH_TO_YOUR_MCP_SERVER_SCRIPT = str((Path(__file__).parent.parent / "fastmcp_server.py").resolve())
DB_MCP_PROMPT = """
